...
func test_process_input():
	...
	text_parser_double.user_instruction_to_return = user_instruction_double

	_input_handler._text_parser = text_parser_double

	var instruction_processor_double = InstructionProcessorDouble.new()
	var instruction_processor_output: Array[String] = ["Instruction output!"]
	instruction_processor_double.process_output_to_return = instruction_processor_output
